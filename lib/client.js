window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@https+++github.com+NOirBRight+dsh-llm-providers-ui+releases+downlo_a94906bf2888b29998ec72e4beabdc2f/node_modules/dsh-llm-providers-ui/lib/usage-readers.js
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@https+++github.com+NOirBRight+dsh-llm-providers-ui+releases+downlo_a94906bf2888b29998ec72e4beabdc2f/node_modules/dsh-llm-providers-ui/lib/provider-ui.js
		/**
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@https+++github.com+NOirBRight+dsh-llm-providers-ui+releases+downlo_a94906bf2888b29998ec72e4beabdc2f/node_modules/dsh-llm-providers-ui/lib/sortable.js
		...
		*/
		...
		function CursorPluginCard(props) {
			...
			(0, react.useEffect)(() => {
				...
				if (liveQuota !== void 0) rememberHeadlineQuota(USAGE_PROVIDER_KEY, USAGE_PROVIDER_NAME, liveQuota);
			}, [
				auth.kind,
			...
			const headerQuota = liveQuota ?? (auth.kind === "signed-in" && !usageAnswered ? headerQuotaFromCache(peekCachedUsage(USAGE_PROVIDER_KEY)) : void 0);
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ProviderCardHeader, {
							...
							role: "llm",
							...headerQuota === void 0 ? auth.kind === "signed-in" && (usage.status === "error" || usage.status === "unsupported") ? { quota: { label: t("usage") } } : {} : { quota: headerQuota }
						})
					}),
