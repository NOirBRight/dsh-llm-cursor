window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region ../../compat-dsh-peer-star/dsh-llm-cursor/node_modules/.pnpm/dsh-llm-providers-ui@https+++github.com+NOirBRight+dsh-llm-providers-ui+releases+downlo_63724c625d388908489c7b24bbeb30f8/node_modules/dsh-llm-providers-ui/lib/usage-readers.js
		...
		*/
		...
		//#endregion
		//#region ../../compat-dsh-peer-star/dsh-llm-cursor/node_modules/.pnpm/dsh-llm-providers-ui@https+++github.com+NOirBRight+dsh-llm-providers-ui+releases+downlo_63724c625d388908489c7b24bbeb30f8/node_modules/dsh-llm-providers-ui/lib/provider-ui.js
		/** Plain-object guard shared by the reader factories and the sidebar cache validator. */
		...
		*/
		...
		//#endregion
		//#region ../../compat-dsh-peer-star/dsh-llm-cursor/node_modules/.pnpm/dsh-llm-providers-ui@https+++github.com+NOirBRight+dsh-llm-providers-ui+releases+downlo_63724c625d388908489c7b24bbeb30f8/node_modules/dsh-llm-providers-ui/lib/sortable.js
		...
		*/
		...
		function apply(ctx) {
			...
			const publishRemoteUnavailable = () => {
				if (closed) return;
				remoteSnapshot = {
					...remoteSnapshot,
					status: "unavailable"
			...
			const publishAccount = (state) => {
				...
				account.state = state;
				try {
					ctx.get("providerDirectory")?.update(CURSOR_SETTINGS_NAMESPACE);
				} catch {}
			};
			...
			ctx.effect(() => {
				if (!connection.isLoopback) rpc.call(CURSOR_RPC_CHANNEL, CURSOR_SETTINGS_READ_ENDPOINT, {}).then((result) => {
					if (closed) return;
					if (!result.ok) {
						publishRemoteUnavailable();
						return;
					}
					const value = result.value;
					const settings = decodeCursorSettings(value.settings);
					if (settings === void 0 || !Number.isSafeInteger(value.revision)) {
						publishRemoteUnavailable();
						return;
					}
