window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@file+..+dsh-providers-settings-a_09d8c27871c984b4c3528f81ddce60f2/node_modules/dsh-llm-providers-ui/lib/usage-readers.js
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@file+..+dsh-providers-settings-a_09d8c27871c984b4c3528f81ddce60f2/node_modules/dsh-llm-providers-ui/lib/provider-ui.js
		/**
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@file+..+dsh-providers-settings-a_09d8c27871c984b4c3528f81ddce60f2/node_modules/dsh-llm-providers-ui/lib/sortable.js
		...
		function CursorPluginCard(props) {
			...
			const loadUsage = async (refresh = false) => {
				...
				try {
					...
					rememberHeadlineQuota("llm-cursor", "Cursor", headlineQuotaOf(read.usage, void 0));
				} catch (error) {
					if (request !== usageEpoch.current) return;
					setUsage({
						status: "error",
			...
			const headerQuota = auth.kind === "signed-out" || auth.kind === "signing-in" || usage.status === "error" || usage.status === "unsupported" ? void 0 : liveQuota ?? headerQuotaFromCache(peekCachedUsage("llm-cursor"));
