...
|---|---|
| 稳定分支 | `main` |
| 当前稳定版（用户安装 / 回滚首选） | `v0.2.18-015rc1c` |
| 上一稳定版（兜底回滚） | `v0.2.17` |
| 集成分支 | `dev` |
| dev HEAD | `8ac5d8f chore: rebuild tracked bundle and fix merge seams (imports, duplicate reader register)` |

### 已折叠进 dev 的历史线

- feat/provider-settings-a
- agent/ui-10-register
- feat/provider-reorder (0.2.13 duplicate line)
